...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xoak-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11485&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xoak-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xoak` can be installed with:

```
conda install xoak
```

It is possible to list all of the versions of `xoak` available on your platform with:
